...
- if a Feature Specification is loaded, show a scenario dropdown immediately before `Clear all`; selecting a scenario selects only usable features whose scenario cell contains the word `feature`.
