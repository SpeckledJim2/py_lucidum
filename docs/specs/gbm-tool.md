...
- include a button to specify whether SHAP values should be created for Zero rows, 10k rows or all rows.
...
This tab lets the user select a single tree in the model from a list and graphically plots that tree.
