...
""")
    ...
    def test_specifications_table_uses_glm_model_navigator_style(self) -> None:
        ...
        self.assertIn("async function validateSpecDraft(spec, options = {})", spec_js)
        self.assertIn("await validateSpecDraft(spec, { showValid: false });", spec_js)
        self.assertIn("function storeValidationResult(spec, result, options = {})", spec_js)
        self.assertIn("function showValidationNotice(result, options = {})", spec_js)
        self.assertIn("if (!spec.generated) await validateSpecOnLoad(spec);", spec_js)
        self.assertIn("await validateSpecOnLoad(cached);", spec_js)
        self.assertIn("function syncGenerationNotice(spec = specs.get(activeKind))", spec_js)
        self.assertIn("spec?.generated ? String(spec.generation_message || \"\") : \"\"", spec_js)
        self.assertIn("if (!spec || spec.generated || spec.dirty || spec.autoValidated) return;", spec_js)
        ...
        self.assertIn('<div id="specNotice" class="spec-notice hidden" role="status" aria-live="polite"></div>', js)
        self.assertIn('<div id="specGenerationNotice" class="spec-generation-notice hidden" role="status" aria-live="polite"></div>', js)
        self.assertLess(js.index('<div class="spec-file-actions">'), js.index('<span id="specFilePath" class="spec-file-path"></span>'))
        self.assertLess(js.index('<div id="specNotice" class="spec-notice hidden" role="status" aria-live="polite"></div>'), js.index('<button id="specValidateBtn"'))
        self.assertLess(js.index('<button id="specSaveBtn"'), js.index('<div id="specGenerationNotice"'))
        self.assertIn('class="tab ${kind.id === activeKind ? "active" : ""}"', js)
        self.assertIn(".spec-generation-notice", css)
        ...
        self.assertIn("await validateSpecDraft(spec, { showValid: false });", delete_row_source)
...
"""
    ...
    def test_sidebar_metric_section_sits_above_fixed_accordion(self) -> None:
        ...
        self.assertIn('<section class="section sidebar-metric-section hidden">', html)
        ...
        self.assertLess(html.index('class="section sidebar-metric-section hidden"'), html.index('data-sidebar-section="kpi"'))
    ...
    def test_sidebar_toggle_contract(self) -> None:
        ...
        self.assertIn("function resizeActiveTool()", js)
