...
"""
    ...
    def test_index_uses_stable_local_asset_urls_and_disables_cache(self) -> None:
        ...
        self.assertIn(".chart-side-controls.chart-expected-collapsed {\n        grid-template-rows: var(--chart-feature-controls-height, minmax(0, 1fr)) 6px;", css)
        ...
        self.assertIn("localStorage.setItem(CHART_FEATURE_CONTROLS_HEIGHT_KEY, CHART_FEATURE_CONTROLS_HEIGHT_COLLAPSED);", js)
...
""")
    ...
    def test_map_layer_control_uses_distinct_radio_groups(self) -> None:
        ...
        self.assertIn('<span id="mapLineWeightLabel">Line width</span>', html)
        ...
        self.assertIn('el("mapLineWeightLabel").textContent = state.mapLevel === "unit" ? "Dot size" : "Line width";', js)
        ...
        self.assertIn('if (id === "mapLabelSize" && state.mapLevel !== "area")', js)
...
"""
    ...
    def test_app_js_contains_unit_point_map_controls(self) -> None:
        ...
        self.assertIn("function unitPointRadiusScale(value = state.mapLineWeight)", js)
