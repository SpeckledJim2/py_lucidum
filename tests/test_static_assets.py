...
""")
    ...
    def test_sidebar_filter_accordion_header_and_row_meta_contract(self) -> None:
        ...
        self.assertIn('id="collapsedFilterIndicator" class="collapsed-filter-indicator" hidden><span>FILTER</span><span>ACTIVE</span></div>', html)
        ...
        self.assertIn(".collapsed-filter-indicator {\n        display: none;\n        margin-top: auto;\n        color: var(--danger);", css)
        self.assertIn("body.sidebar-collapsed .collapsed-filter-indicator:not([hidden]) {\n        display: block;", css)
        self.assertIn(".collapsed-filter-indicator span {\n        display: block;", css)
        ...
        self.assertIn('el("collapsedFilterIndicator").hidden = !applied;', js)
...
""",
    ...
    def test_map_layer_control_uses_distinct_radio_groups(self) -> None:
        ...
        self.assertIn("#lineBarFilter.line-bar-filter--applied,\n      #mapControlFilter.map-filter--applied {\n        color: var(--danger);", css)
    ...
    def test_column_profile_tool_static_assets_are_registered(self) -> None:
        ...
        self.assertIn("#lineBarFilter.line-bar-filter--applied {\n        color: var(--danger);", css)
        self.assertIn("#histogramFilter.histogram-filter--applied {\n        color: var(--danger);", css)
        self.assertIn(".visual-area.dataset-viewer-mode,\n      .visual-area.profile-mode {\n        grid-template-columns: minmax(0, 1fr);", css)
        self.assertIn(".visual-area.dataset-viewer-mode .workspace,\n      .visual-area.profile-mode .workspace {\n        background: transparent;\n        border: 0;", css)
        self.assertIn(".visual-area.dataset-viewer-mode .workspace-messages,\n      .visual-area.profile-mode .workspace-messages {\n        display: none;", css)
