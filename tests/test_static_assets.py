...
class StaticAssetTests(unittest.TestCase):
    ...
    def test_index_uses_stable_local_asset_urls_and_disables_cache(self) -> None:
        ...
        self.assertIn('<h2>GBM models</h2>', html)
    ...
    def test_gbm_frontend_contains_real_tool_contract(self) -> None:
        ...
        self.assertLess(js.index('id="gbmTrainBtn"'), js.index('id="gbmShapRows"'))
        self.assertLess(js.index('id="gbmShapRows"'), js.index('id="gbmCreateSampleBtn"'))
        ...
        self.assertIn("grid: { left: 12, right: 82, top: 42, bottom: 38, containLabel: true }", js)
        ...
        self.assertIn(".gbm-sample-button.active", css)
        ...
        self.assertIn(".gbm-model-table-wrap {\n        background: var(--panel);", css)
        ...
        self.assertIn(".gbm-model-activate-button", css)
        ...
        self.assertIn('return `${model.response_column || "actualNumerator"} / ${model.offset_column || "Average row value"}`;', js)
        ...
        self.assertIn("<th>Response</th>", js)
        self.assertIn("<th>Weight</th>", js)
        self.assertIn("<th>Scored</th>", js)
        self.assertIn("<th>Run time</th>", js)
        self.assertIn("<th>Sample</th>", js)
        ...
        self.assertIn("function formatSampleMode(value)", js)
