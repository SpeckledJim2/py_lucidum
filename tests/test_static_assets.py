...
class StaticAssetTests(unittest.TestCase):
    ...
    def test_saved_filter_select_uses_feature_list_row_spacing(self) -> None:
        ...
        self.assertIn(".saved-filter-list .feature {\n        display: grid;\n        grid-template-columns: minmax(0, 1fr) minmax(72px, 45%);", css)
        ...
        self.assertIn('heading.setAttribute("role", "presentation");', js)
        self.assertIn("heading.textContent = theme;", js)
    ...
    def test_filter_panel_collapses_and_shows_row_meta(self) -> None:
        ...
        self.assertIn('aria-label="Collapse filter"', html)
        ...
        self.assertIn(".sidebar-filter-section.filter-collapsed .filter-input-row,", css)
        self.assertIn(".sidebar-filter-section.filter-collapsed #savedFilterSelect,", css)
        self.assertIn(".sidebar-filter-section.filter-collapsed .filter-operator {\n        display: none;", css)
        ...
        self.assertIn("filterCollapsed: false", js)
