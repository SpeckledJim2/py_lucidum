...
"""
    ...
    def test_gbm_frontend_contains_real_tool_contract(self) -> None:
        ...
        self.assertIn('if (menu.classList.contains("hidden")) syncFeatureInteractionCounts(currentFeatureRows());', js)
        self.assertIn("function applyFeatureScenario(name)", js)
        self.assertIn("function resetFeatureScenarioSelect()", js)
        ...
        self.assertIn('class="gbm-interaction-constraint-button${constraintClass}"', js)
        ...
        self.assertIn(".gbm-interaction-constraint-button.has-constraints", css)
