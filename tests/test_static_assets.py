...
"""
    ...
    def test_glm_frontend_contains_real_tool_contract(self) -> None:
        ...
        self.assertIn("function tabulationModelListHtml(models = [], selectedIds = [])", glm_js)
        self.assertIn('{ kind: "glm", label: "GLMs"', glm_js)
        self.assertIn('{ kind: "gbm", label: "GBMs"', glm_js)
        self.assertIn('class="saved-filter-theme glm-tabulation-model-group"', glm_js)
        self.assertIn('data-glm-tabulation-model-group="${group.kind}"', glm_js)
        ...
        self.assertIn(".glm-tabulation-model-group", css)
