...
class StaticAssetTests(unittest.TestCase):
    ...
    def test_map_layer_control_uses_distinct_radio_groups(self) -> None:
        ...
        self.assertIn(".filter(({ row, value }) => row.key !== null && row.key !== undefined && value !== null)", js)
    ...
    def test_column_profile_tool_static_assets_are_registered(self) -> None:
        ...
        self.assertIn('const showLabels = bins.length < 50;', js)
        ...
        self.assertIn('profile-detail-histogram${showLabels ? " profile-detail-histogram-labelled" : ""}', js)
        ...
        profile_histogram_block = css[css.index(".profile-detail-histogram {"):css.index(".profile-detail-histogram-labelled {")]
        self.assertNotIn("overflow-x: auto;", profile_histogram_block)
        self.assertIn("flex: 1 1 0;\n        position: relative;\n        height: 100%;\n        min-width: 0;", css)
        self.assertIn(".profile-detail-histogram-labelled {", css)
        self.assertIn(".profile-detail-histogram-labelled .profile-detail-bin {\n        padding-bottom: 14px;", css)
