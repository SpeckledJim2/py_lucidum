...
class StaticAssetTests(unittest.TestCase):
    ...
    def test_index_uses_stable_local_asset_urls_and_disables_cache(self) -> None:
        ...
        self.assertIn('id="monitorLink" class="ghost monitor-link" href="/monitor" target="_blank"', html)
    ...
    def test_monitor_page_disables_cache(self) -> None:
        ...
        self.assertIn("<h2>Server</h2>", html)
        ...
        self.assertIn("grid-template-columns: minmax(0, 1fr) minmax(170px, max-content);", css)
