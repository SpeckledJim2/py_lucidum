...
""",
    ...
    def test_dataset_viewer_tool_static_assets_are_registered(self) -> None:
        ...
        self.assertIn("setTransposedColumnRowSelected(field", dataset_js)
        self.assertIn("setTransposedRowColumnSelected(transposedFieldForDatasetRowId(rowId)", dataset_js)
        ...
        self.assertIn("Copy row", dataset_js)
        self.assertIn("Copy column", dataset_js)
        self.assertIn("Copy to clipboard", dataset_js)
        self.assertIn('openDatasetViewerContextMenu(event, { mode: "selection"', dataset_js)
