...
""")
    ...
    def test_specifications_table_uses_glm_model_navigator_style(self) -> None:
        ...
        self.assertLess(js.index('<span id="specFilePath" class="spec-file-path"></span>'), js.index('<div id="specNotice" class="spec-notice hidden" role="status" aria-live="polite"></div>'))
        self.assertLess(js.index('<div id="specNotice" class="spec-notice hidden" role="status" aria-live="polite"></div>'), js.index('<div id="specGenerationNotice" class="spec-generation-notice hidden" role="status" aria-live="polite"></div>'))
        ...
        self.assertIn(".spec-notice.hidden {\n        display: block;\n        visibility: hidden;", css)
