...
class StaticAssetTests(unittest.TestCase):
    ...
    def test_column_profile_tool_static_assets_are_registered(self) -> None:
        ...
        self.assertIn("function formatProfileEntropy(value)", js)
        self.assertIn('return Math.max(0, Math.min(1, number)).toFixed(3);', js)
        self.assertIn('<span><strong>${escapeHtml(formatProfileEntropy(data.entropy_score))}</strong> entropy</span>', js)
