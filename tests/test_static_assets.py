...
"""
    ...
    def test_line_bar_favourites_static_contract(self) -> None:
        ...
        self.assertIn('id="sidebarFavouriteMenuBtn" class="line-bar-favourite-icon-button sidebar-favourite-icon-button" type="button" title="Edit favourites" aria-label="Edit favourites">Edit favourites</button>', html)
        self.assertIn('id="sidebarFavouriteAddBtn" class="line-bar-favourite-icon-button sidebar-favourite-icon-button" type="button" title="Add favourite" aria-label="Add favourite">Add favourite</button>', html)
        self.assertLess(html.index('id="sidebarFavouriteMenuBtn"'), html.index('id="sidebarFavouriteAddBtn"'))
        ...
        self.assertIn("applyStartupFavourite", main_js)
...
"""
    ...
    def test_index_uses_stable_local_asset_urls_and_disables_cache(self) -> None:
        ...
        self.assertIn("filter: brightness(0) saturate(100%) invert(16%) sepia(14%)", css)
        ...
        self.assertIn('button.addEventListener("pointerenter", () => showToolButtonTooltip(button));', js)
...
""")
    ...
    def test_sidebar_metric_section_sits_above_fixed_accordion(self) -> None:
        ...
        self.assertLess(html.index('class="section sidebar-metric-section"'), html.index('data-sidebar-section="favourites"'))
        self.assertLess(html.index('data-sidebar-section="favourites"'), html.index('data-sidebar-section="kpi"'))
        self.assertLess(html.index('data-sidebar-section="kpi"'), html.index('data-sidebar-section="gbm"'))
        self.assertLess(html.index('data-sidebar-section="gbm"'), html.index('data-sidebar-section="glm"'))
        self.assertLess(html.index('data-sidebar-section="glm"'), html.index('data-sidebar-section="filter"'))
        self.assertLess(html.index('id="actualNumerator"'), html.index('id="favouritesSelect"'))
        self.assertLess(html.index('id="denominator"'), html.index('id="favouritesSelect"'))
...
""",
    ...
    def test_sidebar_toggle_contract(self) -> None:
        ...
        self.assertIn("padding: 0;\n        border-radius: 0;", css)
        self.assertIn("body.sidebar-collapsed .tool-icon {\n        width: 30px;\n        height: 30px;", css)
        self.assertIn("body.sidebar-collapsed .tool-icon svg {\n        width: 28px;\n        height: 28px;", css)
        self.assertIn("body.sidebar-collapsed .tool-icon img {\n        width: 30px;\n        height: 30px;", css)
        ...
        self.assertIn("body.sidebar-collapsed .tool-selector {\n        display: grid;", css)
        ...
        self.assertIn("if (state.tool === tool) return;", js)
        self.assertNotIn("if (state.tool === tool) {\n          setSidebarVisible(!state.sidebarVisible);", js)
    ...
    def test_tool_selector_aligns_with_main_toolbar(self) -> None:
        ...
        self.assertIn("body.sidebar-collapsed .tool-selector-section {\n        width: 100%;\n        margin-bottom: 0;\n        padding-top: 0;", css)
