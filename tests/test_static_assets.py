...
"""
    ...
    def test_line_bar_favourites_static_contract(self) -> None:
        ...
        favourites_header = html.index('<div class="sidebar-section-header-row sidebar-favourites-header-row">', favourites_start)
        ...
        self.assertIn(".sidebar-section-header-row,\n      .sidebar-favourites-header-row {\n        display: flex;\n        align-items: center;\n        gap: 2px;", css)
        self.assertIn(".sidebar-section-header-row .sidebar-section-header {\n        flex: 0 0 auto;\n        width: auto;", css)
        self.assertIn(".sidebar-section-header-row:hover .sidebar-section-header,\n      .sidebar-section-header-row:focus-within .sidebar-section-header,", css)
        self.assertIn(".sidebar-section-header-row:hover .favourites-selected-meta,\n      .sidebar-section-header-row:focus-within .favourites-selected-meta,", css)
        ...
        self.assertIn(".sidebar-favourites-section.sidebar-section-open .sidebar-favourites-controls {\n        display: grid;\n        pointer-events: auto;", css)
        self.assertNotIn(".sidebar-favourites-header-row:hover .sidebar-favourites-controls,\n      .sidebar-favourites-header-row:focus-within .sidebar-favourites-controls", css)
        ...
        self.assertIn(".sidebar-favourite-icon-button.line-bar-favourite-icon-button:hover,\n      .sidebar-favourites-header-row:hover .sidebar-favourite-icon-button.line-bar-favourite-icon-button,\n      .sidebar-favourites-header-row:focus-within .sidebar-favourite-icon-button.line-bar-favourite-icon-button,\n      .sidebar-favourite-icon-button.line-bar-favourite-icon-button:focus-visible {\n        color: var(--accent);", css)
        ...
        self.assertIn('const FAVOURITE_SCOPES = new Set(["metrics", "metrics_filter", "line_bar_view", "histogram_view", "map_view", "dataset_view"]);', main_js)
        self.assertIn('FAVOURITE_SCOPES = {"metrics", "metrics_filter", "line_bar_view", "histogram_view", "map_view", "dataset_view"}', favourites_py)
        self.assertIn('if scope == "dataset_view":', favourites_py)
        self.assertIn('if scope in {"metrics_filter", "line_bar_view", "histogram_view", "map_view"}:', favourites_py)
        self.assertIn('histogram_view: "Histogram view",', main_js)
        self.assertIn('map_view: "Map view",', main_js)
        self.assertIn('dataset_view: "Dataset view",', main_js)
        self.assertIn("captureFavouriteView", main_js)
        self.assertIn("captureHistogramFavouriteView", main_js)
        self.assertIn("captureDatasetFavouriteView", main_js)
        self.assertIn("captureLineBarFavouriteView", main_js)
        self.assertIn("applyLineBarFavouriteView", main_js)
        self.assertIn("applyHistogramFavouriteView", main_js)
        self.assertIn("applyHistogramFavouriteStateOnly", main_js)
        self.assertIn("applyDatasetFavouriteView", main_js)
        self.assertIn("applyDatasetFavouriteStateOnly", main_js)
        self.assertIn("syncFilterRowMetaFromToolData(data);\n        await refreshMetricSummaryForVisibleControls({ force: true });", main_js)
        ...
        self.assertIn('return tool === "line_bar" || tool === "histogram" || tool === "uk_map" || tool === "dataset_viewer";', main_js)
        ...
        self.assertIn('if (state.tool === "dataset_viewer") return "dataset_view";', main_js)
        self.assertIn('if (state.tool === "histogram") return "histogram_view";', main_js)
        ...
        self.assertIn("HISTOGRAM_FAVOURITE_SCOPE_OPTIONS", main_js)
        self.assertIn("DATASET_VIEW_FAVOURITE_SCOPE_OPTIONS", main_js)
        self.assertIn('["line_bar_view", FAVOURITE_SCOPE_LABELS.line_bar_view]', main_js)
        self.assertIn('["histogram_view", FAVOURITE_SCOPE_LABELS.histogram_view]', main_js)
        self.assertIn('["map_view", FAVOURITE_SCOPE_LABELS.map_view]', main_js)
        self.assertIn('["dataset_view", FAVOURITE_SCOPE_LABELS.dataset_view]', main_js)
...
if (!toolSupportsFavouriteAdd("histogram")) throw new Error("histogram should allow favourite adds");
if (!toolSupportsFavouriteAdd("uk_map")) throw new Error("uk_map should allow favourite adds");
if (!toolSupportsFavouriteAdd("dataset_viewer")) throw new Error("dataset_viewer should allow favourite adds");
for (const tool of ["column_profile", "glm", "gbm", "specs"]) {
...
"""
    ...
    def test_index_uses_stable_local_asset_urls_and_disables_cache(self) -> None:
        ...
        self.assertIn(".gbm-model-list .gbm-empty-state,\n      .glm-model-list .glm-empty-state {", css)
        model_empty_state_block = css[
            css.index(".gbm-model-list .gbm-empty-state,"):
            css.index(".favourites-list .saved-favourite-option {")
        ]
        self.assertIn("align-items: center;", model_empty_state_block)
        self.assertIn("background: color-mix(in srgb, var(--muted) 6%, transparent);", model_empty_state_block)
        self.assertIn("border-bottom: 1px solid var(--line);", model_empty_state_block)
        self.assertIn("color: var(--muted);", model_empty_state_block)
        self.assertIn("display: flex;", model_empty_state_block)
        self.assertIn("font-size: 10px;", model_empty_state_block)
        self.assertIn("font-weight: 400;", model_empty_state_block)
        self.assertIn("line-height: 1.35;", model_empty_state_block)
        self.assertIn("min-height: 24px;", model_empty_state_block)
        self.assertIn("padding: 3px 6px;", model_empty_state_block)
    ...
    def test_static_app_assets_disable_cache(self) -> None:
        ...
        model_css = self.assert_no_store("/static/styles/model-shell.css")[1].decode("utf-8")
        ...
        self.assertIn("main:has(> #visualArea.dataset-viewer-mode) {\n        background: var(--panel);", dataset_css)
        self.assertIn(".visual-area.dataset-viewer-mode .workspace {\n        background: var(--panel);", dataset_css)
        self.assertIn("main:has(> #visualArea.model-mode) {\n        background: var(--panel);\n        padding: 0;", model_css)
        self.assertIn(".visual-area.model-mode .workspace {\n        background: var(--panel);\n        border-color: transparent;\n        border-radius: 0;\n        box-shadow: none;\n        padding: 0;", model_css)
        self.assertIn(".visual-area.model-mode .model-tool-wrap {\n        padding: 8px;", model_css)
...
""")
    ...
    def test_line_bar_warnings_render_inside_chart_messages(self) -> None:
        ...
        self.assertIn("function lineBarExclusionWarnings(data)", js)
        self.assertIn("function lineBarDisplayWarnings(data)", js)
        self.assertIn("function lineBarGroupMetaWithExclusions(groupLabel, rowMeta, data)", js)
        self.assertIn('return exclusions.length ? `${base}. ${exclusions.join(". ")}` : base;', js)
        self.assertIn("const exclusionSet = new Set(lineBarExclusionWarnings(data));", js)
        self.assertIn("const groupMeta = lineBarGroupMetaWithExclusions(groupLabel, rowMeta, data);", js)
        self.assertIn('const warnings = lineBarDisplayWarnings(data).join(" ");', js)
        ...
        self.assertIn("exclusion_warnings: Array.isArray(data?.exclusion_warnings) ? [...data.exclusion_warnings] : data?.exclusion_warnings,", js)
    ...
    def test_specifications_table_uses_glm_model_navigator_style(self) -> None:
        ...
        self.assertIn("main:has(> #visualArea.specs-mode) {\n        background: var(--panel);\n        padding: 0;", css)
        self.assertIn(".visual-area.specs-mode .workspace {\n        background: var(--panel);\n        border-color: transparent;\n        border-radius: 0;\n        box-shadow: none;\n        padding: 0;", css)
        self.assertIn(".visual-area.specs-mode .specifications-wrap {\n        padding: 8px;", css)
    ...
    def test_line_bar_table_search_uses_complete_table_client_filter(self) -> None:
        ...
        self.assertIn("const weightedMode = Boolean(data.denominator?.column);", js)
        self.assertIn("const summaryRowCount = Number.isFinite(Number(data.summary?.row_count)) ? Number(data.summary.row_count) : summaryVolume;", js)
        self.assertIn('content.innerHTML = `<div id="lineBarTableGrid" class="line-bar-table-grid"></div>${pager}`;', js)
        self.assertIn("function lineBarTableMaxHeight()", js)
        self.assertIn('const pager = content.querySelector(".table-pagination");', js)
        self.assertIn("function syncLineBarTableMaxHeight()", js)
        self.assertIn("function lineBarTableHeaderMinWidth(label, minimum)", js)
        self.assertIn("minWidth: lineBarTableHeaderMinWidth(data.x, 130),", js)
        self.assertIn("minWidth: lineBarTableHeaderMinWidth(weightLabel, 90),", js)
        self.assertIn("minWidth: lineBarTableHeaderMinWidth(response.label, 110),", js)
        self.assertIn("loadTabulator().then((Tabulator) => {", js)
        render_table_source = self.js_function_source(js, "renderLineBarTableContents")
        self.assertNotIn('height: "100%",', render_table_source)
        self.assertIn("const maxHeight = syncLineBarTableMaxHeight();", render_table_source)
        self.assertIn("maxHeight,", render_table_source)
        self.assertIn('renderVertical: "virtual",', js)
        self.assertIn("rowHeight: 22,", js)
        self.assertIn("selectableRows: true,", js)
        self.assertIn("headerWordWrap: true,", js)
        resize_source = self.js_function_source(line_bar_js, "resize")
        self.assertIn('if (state.view === "table") {', resize_source)
        self.assertIn("syncLineBarTableMaxHeight();", resize_source)
        self.assertIn("lineBarTable?.redraw?.(true);", resize_source)
        ...
        self.assertIn('...(weightedMode ? [{ title: "Row count", field: "row_count" }] : []),', js)
        self.assertIn("row_count: formatNumber(rowCount === null ? row.volume : rowCount),", js)
        self.assertIn("...(weightedMode ? { row_count: formatNumber(summaryRowCount) } : {}),", js)
        self.assertIn("bottomCalc: () => formatNumber(summaryRowCount),", js)
        ...
        self.assertIn(".line-bar-table-grid {\n        flex: 0 1 auto;", css)
        self.assertIn(".line-bar-table-grid.tabulator {\n        background: var(--panel);\n        border: 1px solid var(--line);", css)
        self.assertIn(".line-bar-table-grid.tabulator .tabulator-header .tabulator-col .tabulator-col-content .tabulator-col-title {\n        overflow-wrap: anywhere;\n        text-overflow: clip;\n        white-space: normal;", css)
    ...
    def test_sidebar_filter_accordion_header_and_row_meta_contract(self) -> None:
        ...
        self.assertIn('<div class="sidebar-section-header-row filter-header">', html)
        ...
        self.assertIn(".sidebar-section-header-row .sidebar-section-header {\n        flex: 0 0 auto;\n        width: auto;", css)
        self.assertIn(".sidebar-section-header-row:hover .sidebar-section-header,\n      .sidebar-section-header-row:focus-within .sidebar-section-header,", css)
        self.assertIn(".sidebar-section-header-row:hover .filter-row-meta,\n      .sidebar-section-header-row:focus-within .filter-row-meta,", css)
    ...
    def test_sidebar_metric_section_sits_above_accordions_for_all_tools(self) -> None:
        _, html_body = self.assert_no_store("/")
        css = self.app_css_contract()
        html = html_body.decode("utf-8")
        js = self.app_js_contract()
        ...
        favourites_start = html.index('data-sidebar-section="favourites"')
        kpi_start = html.index('data-sidebar-section="kpi"')
        gbm_start = html.index('data-sidebar-section="gbm"')
        glm_start = html.index('data-sidebar-section="glm"')
        filter_start = html.index('data-sidebar-section="filter"')
        metric_start = html.index('class="section sidebar-metric-section"')
        self.assertLess(metric_start, favourites_start)
        self.assertLess(favourites_start, kpi_start)
        self.assertLess(kpi_start, gbm_start)
        self.assertLess(gbm_start, glm_start)
        self.assertLess(glm_start, filter_start)
        ...
        for section_start, meta_id in (
            (kpi_start, 'id="kpiSelectedMeta"'),
            (gbm_start, 'id="gbmModelSelectedMeta"'),
            (glm_start, 'id="glmModelSelectedMeta"'),
        ):
            self.assertLess(html.index("</button>", section_start), html.index(meta_id, section_start))
        ...
        self.assertIn(".sidebar-metric-section {\n        flex: 0 0 auto;\n        margin: 0 -8px 10px;\n        padding: 0 8px 9px;\n        border-bottom: 1px solid color-mix(in srgb, var(--line) 70%, transparent);", css)
        self.assertNotIn(".sidebar-metric-section {\n        flex: 0 0 auto;\n        margin: 0 0 10px;\n        padding: 7px 0 9px;\n        border-top:", css)
        ...
        self.assertIn("function syncSidebarAccordion()", js)
        self.assertIn("function activeToolUsesSidebarMetrics()", js)
        self.assertIn("function activeToolUsesSidebarMetrics() {\n        return true;\n      }", js)
        self.assertIn('document.querySelector(".sidebar-metric-section")?.classList.toggle("hidden", !activeToolUsesSidebarMetrics());', js)
        self.assertIn("function refreshMetricSummaryForVisibleControls(options = {})", js)
        self.assertIn("if (!activeToolUsesSidebarMetrics()) return Promise.resolve(null);", js)
        self.assertIn("refreshMetricSummaryForVisibleControls();\n          refreshActiveTool();", js)
        self.assertIn("function metricSummaryFromToolData(data)", js)
        self.assertIn('if (!responseSummaries.some((summary) => summary && Object.prototype.hasOwnProperty.call(summary, "value"))) return null;', js)
        self.assertIn("if (!summary) return false;", js)
        self.assertNotIn('document.querySelector(".sidebar-metric-section")?.classList.toggle("hidden", state.openSidebarSection !== null);', js)
...
""",
    ...
    def test_map_layer_control_uses_distinct_radio_groups(self) -> None:
        ...
        self.assertNotIn("<span>Line width</span>", html)
        ...
        self.assertIn('<div id="mapRowMeta" class="workspace-meta"></div>', html)
        ...
        self.assertIn("width: min(244px, calc(100% - 24px));", css)
        self.assertNotIn("width: min(400px, calc(100% - 64px));", css)
        self.assertIn(".map-floating-control.collapsed {\n        width: 36px;\n        height: 36px;", css)
        self.assertIn("background: transparent;\n        box-shadow: none;\n        overflow: visible;", css)
        self.assertIn(".map-floating-control.collapsed .map-floating-header strong,\n      .map-floating-control.collapsed .map-floating-header #mapGroupMeta,\n      .map-floating-control.collapsed .map-floating-header #mapRowMeta,\n      .map-floating-control.collapsed .map-floating-header #mapControlFilter,", css)
        self.assertIn(".map-floating-header #mapRowMeta {\n        min-height: 1.1em;", css)
        ...
        self.assertIn("--map-control-tile-size: 70px;", css)
        self.assertNotIn("--map-control-tile-size: 66px;", css)
        self.assertNotIn("--map-control-tile-size: 64px;", css)
        self.assertNotIn("--map-control-tile-size: 58px;", css)
        self.assertIn(".map-base-layer-tiles {\n        grid-template-columns: repeat(3, minmax(0, var(--map-control-tile-size)));", css)
        self.assertNotIn("grid-template-columns: repeat(6, minmax(0, var(--map-control-tile-size)));", css)
        self.assertIn(".map-level-tiles {\n        grid-template-columns: repeat(3, minmax(0, var(--map-control-tile-size)));", css)
        self.assertIn(".map-level-palette-row {\n        display: grid;\n        grid-template-columns: max-content;", css)
        self.assertNotIn("grid-template-columns: repeat(2, max-content);", css)
        self.assertIn("align-items: start;\n        gap: 6px;", css)
        self.assertIn(".map-level-palette-row .map-tile-section + .map-tile-section {\n        padding-top: 2px;", css)
        ...
        self.assertIn("display: grid;\n        grid-template-columns: 58px max-content minmax(0, 1fr) max-content;", css)
        self.assertNotIn("grid-template-columns: 66px max-content minmax(0, 1fr) max-content;", css)
        self.assertNotIn("grid-template-columns: 62px max-content minmax(0, 1fr) max-content;", css)
        self.assertIn("grid-template-columns: 58px max-content minmax(0, 1fr) max-content;\n        align-items: center;\n        gap: 4px;", css)
        ...
        self.assertIn("function setMapRowMeta(message)", js)
        self.assertIn('el("mapRowMeta").textContent = message || "";', js)
        self.assertIn("function mapRowMetaForData(data)", js)
        self.assertIn("const rowMeta = mapRowMetaForData(data);", js)
        self.assertIn('setMapRowMeta(mapRowMetaForData(cache.data));', js)
        self.assertIn('const groupMeta = `${matchedFeatureCount.toLocaleString()} / ${featureCount.toLocaleString()} ${levelConfig.label} matched`;', js)
        self.assertIn('const groupMeta = `${plottedCount.toLocaleString()} / ${summaryCount.toLocaleString()} units plotted`;', js)
        self.assertIn("setMapRowMeta(rowMeta);", js)
        self.assertNotIn("matched · ${rowMeta}", js)
        self.assertNotIn("units plotted · ${rowMeta}", js)
        self.assertIn("        .map-floating-control {\n          --map-floating-right: 11px;", css)
        self.assertNotIn("width: min(440px, calc(100% - 24px));", css)
        self.assertNotIn("width: min(208px, calc(100% - 16px));", css)
        self.assertIn("        .postcode-search {\n          grid-template-columns: minmax(0, 1fr) 28px 28px;", css)
        self.assertNotIn("        .map-slider-control {\n          grid-template-columns: 62px minmax(0, 1fr);", css)
        self.assertNotIn("        .map-slider-control > span:first-child {\n          display: none;", css)
        self.assertNotIn("        .slider-scale b:first-child,\n        .slider-scale b:last-child {\n          display: none;", css)
        self.assertNotIn("        .map-slider-control input[type=\"range\"] {\n          grid-column: 2;", css)
    ...
    def test_sidebar_toggle_contract(self) -> None:
        ...
        self.assertIn("--sidebar-bg: var(--panel-2);", css)
        self.assertEqual(css.count("--sidebar-bg: var(--panel-2);"), 2)
        self.assertIn(".chart-side-section {\n        background: var(--panel-2);", css)
        ...
        self.assertIn(".shell {\n        display: grid;\n        grid-template-columns: var(--sidebar-width, 400px) 1px minmax(0, 1fr);", css)
        self.assertIn(".sidebar-control-pane {\n        display: flex;\n        flex-direction: column;\n        grid-column: 2;", css)
        self.assertNotIn(".sidebar-control-pane {\n        border-left: 1px solid var(--line);", css)
        self.assertIn("body.single-tool-mode .sidebar-control-pane {\n        grid-column: 1;", css)
        self.assertIn(".sidebar-resizer {\n        background: transparent;\n        cursor: col-resize;\n        inline-size: 9px;\n        margin-inline: -4px;\n        min-width: 9px;", css)
        self.assertIn(".sidebar-resizer::before {\n        background: var(--line);\n        content: \"\";\n        inset-block: 0;\n        inset-inline-start: 4px;\n        position: absolute;\n        width: 1px;", css)
        self.assertIn(".sidebar-resizer:hover,\n      .sidebar-resizer.dragging {\n        background: transparent;", css)
        self.assertIn(".sidebar-resizer:hover::before,\n      .sidebar-resizer.dragging::before {\n        background: var(--line);", css)
    ...
    def test_dataset_viewer_tool_static_assets_are_registered(self) -> None:
        ...
        self.assertIn('id="datasetViewerSummaryMeta" class="dataset-viewer-summary-meta"', dataset_js)
        self.assertIn('id="datasetViewerCount" class="dataset-viewer-count"', dataset_js)
        self.assertIn('id="datasetViewerCountSeparator" class="dataset-viewer-meta-separator"', dataset_js)
        ...
        self.assertIn('const summary = document.getElementById("datasetViewerSummaryMeta");', dataset_js)
        self.assertIn('if (separator.parentElement !== summary || separator.previousElementSibling !== count) count.after(separator);', dataset_js)
        self.assertIn('if (groupMeta.parentElement !== summary) summary.append(groupMeta);', dataset_js)
        ...
        self.assertIn("initialSort: normalSorters.length ? tabulatorNormalSorters(normalSorters) : false,", dataset_js)
        ...
        self.assertIn("let renderedSort = null;", dataset_js)
        self.assertIn("let normalSorters = [];", dataset_js)
        self.assertIn("let restoredFavouriteNormalSorters = [];", dataset_js)
        self.assertIn("let normalColumnWidths = new Map();", dataset_js)
        self.assertIn("let transposedColumnWidths = new Map();", dataset_js)
        self.assertIn("let normalUserColumnWidths = new Map();", dataset_js)
        self.assertIn("let transposedUserColumnWidths = new Map();", dataset_js)
        self.assertIn("let pendingFavouritePinnedColumnNames = null;", dataset_js)
        self.assertIn("let pendingFavouriteNormalColumnWidths = null;", dataset_js)
        self.assertIn("let pendingFavouriteNormalSorters = null;", dataset_js)
        self.assertIn("let pendingFavouriteTransposedSort = null;", dataset_js)
        ...
        self.assertIn('datasetTable.on("dataSorted", handleNormalDataSorted);', dataset_js)
        self.assertIn("function snapshotDatasetViewerColumnWidths()", dataset_js)
        self.assertIn("function snapshotNormalTableSorters()", dataset_js)
        self.assertIn("function captureFavouriteState()", dataset_js)
        self.assertIn("function applyFavouriteState(datasetView = {})", dataset_js)
        self.assertIn("function normalFavouriteColumnWidths()", dataset_js)
        self.assertIn("function favouriteNormalSorters()", dataset_js)
        self.assertIn("function favouriteNormalSortEntries(values)", dataset_js)
        self.assertIn("function normaliseFavouriteTransposedSort(value)", dataset_js)
        self.assertIn("function resolvePendingFavouriteDatasetView(sourceColumns)", dataset_js)
        self.assertIn("function resolveFavouriteNormalSorters(sorters, fieldByName)", dataset_js)
        self.assertIn("pinnedColumns: favouritePinnedColumnNames(),", dataset_js)
        self.assertIn("normal: normalFavouriteColumnWidths(),", dataset_js)
        self.assertIn("transposed: favouriteWidthObject(transposedUserColumnWidths),", dataset_js)
        self.assertIn("sort: {\n        normal: favouriteNormalSorters(),\n        transposed: favouriteTransposedSort(),\n      },", dataset_js)
        self.assertIn("pendingFavouritePinnedColumnNames = next.pinnedColumns;", dataset_js)
        self.assertIn("pendingFavouriteNormalColumnWidths = next.columnWidths.normal;", dataset_js)
        self.assertIn("pendingFavouriteNormalSorters = next.sort.normal;", dataset_js)
        self.assertIn("restoredFavouriteNormalSorters = next.sort.normal.map((sorter) => ({ ...sorter }));", dataset_js)
        self.assertIn("pendingFavouriteTransposedSort = next.sort.transposed;", dataset_js)
        ...
        self.assertIn("resolvePendingFavouriteDatasetView(sourceColumns);", dataset_js)
        ...
        self.assertIn("function tabulatorNormalSorters(sorters)", dataset_js)
        self.assertIn("function applyNormalSortersForRender()", dataset_js)
        self.assertIn("function scheduleNormalSortersForRender(token, requestKey, attempt = 0)", dataset_js)
        self.assertIn("function handleNormalDataSorted()", dataset_js)
        self.assertIn("restoredFavouriteNormalSorters = [];\n      markDatasetViewChanged();", dataset_js)
        self.assertIn("markDatasetViewChanged();\n  }\n\n  function resetSelections()", dataset_js)
        ...
        self.assertIn("reconcileRenderedSearch(token, requestKey, () => {", dataset_js)
        ...
        self.assertIn(".dataset-viewer-search-row {\n          flex: 1 1 100%;", dataset_css)
        self.assertIn(".dataset-viewer-meta {", dataset_css)
        self.assertIn(".dataset-viewer-summary-meta {\n        align-items: center;\n        display: flex;\n        flex: 0 1 auto;\n        gap: 4px;\n        justify-content: flex-end;", dataset_css)
        self.assertIn(".dataset-viewer-count:empty + .dataset-viewer-meta-separator {\n        display: none;", dataset_css)
        self.assertIn("flex-direction: column;\n        gap: 4px;", dataset_css)
        self.assertIn("max-width: min(440px, 46%);", dataset_css)
        self.assertIn(".dataset-viewer-meta .workspace-meta,\n      .dataset-viewer-meta .dataset-viewer-count,\n      .dataset-viewer-meta #datasetViewerFilter {\n        max-width: 100%;\n        min-width: 0;\n        overflow: hidden;\n        text-overflow: ellipsis;\n        white-space: nowrap;", dataset_css)
    ...
    def test_column_profile_tool_static_assets_are_registered(self) -> None:
        ...
        self.assertIn(".visual-area.dataset-viewer-mode,\n      .visual-area.profile-mode {\n        grid-template-columns: minmax(0, 1fr);", css)
        self.assertIn(".visual-area.dataset-viewer-mode .workspace,\n      .visual-area.profile-mode .workspace {\n        background: transparent;\n        border: 0;", css)
        self.assertIn("main:has(> #visualArea.profile-mode) {\n        background: var(--panel);", css)
        self.assertIn(".visual-area.profile-mode .workspace {\n        background: var(--panel);", css)
        self.assertIn(".visual-area.dataset-viewer-mode .workspace-messages,\n      .visual-area.profile-mode .workspace-messages {\n        display: none;", css)
    ...
    def test_histogram_tool_static_assets_are_registered(self) -> None:
        ...
        self.assertIn("function captureFavouriteState()", js)
        self.assertIn("function applyFavouriteState(payload = {})", js)
        self.assertIn("clearActiveFavouriteSelection = () => {},", js)
        self.assertIn("if (state[control] !== previousValue) clearActiveFavouriteSelection();", js)
        self.assertIn('el("histogramBins").addEventListener("input", () => {\n      clearActiveFavouriteSelection();\n      scheduleHistogramBinsRefresh();', js)
        self.assertIn("captureFavouriteState,\n    applyFavouriteState,", js)
        ...
        self.assertIn(".histogram-grid {\n        background: var(--panel);\n        border: solid var(--line);\n        border-width: 1px 0 0;", css)
        self.assertIn(".histogram-grid.tabulator {\n        border: solid var(--line);\n        border-width: 1px 0 0;", css)
        self.assertIn(".histogram-grid.tabulator .tabulator-header .tabulator-col {\n        font-size: 11px;", css)
        self.assertIn('.histogram-grid.tabulator .tabulator-header .tabulator-col[tabulator-field="statistic"] {\n        border-left: 1px solid var(--line) !important;', css)
        ...
        self.assertIn('.histogram-grid .tabulator-row .tabulator-cell[tabulator-field="statistic"] {\n        border-left: 1px solid color-mix(in srgb, var(--line) 80%, transparent);', css)
        ...
        self.assertIn("@media (max-width: 900px) {\n        .histogram-wrap {\n          grid-template-columns: minmax(0, 1fr);\n          grid-template-rows: minmax(160px, 34%) minmax(0, 1fr);", css)
        self.assertIn(".histogram-stats-panel {\n          padding-top: 22px;", css)
