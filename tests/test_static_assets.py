...
"""
    ...
    def test_filter_panel_collapses_and_shows_row_meta(self) -> None:
        ...
        self.assertLess(html.index('id="filterRowMeta"'), html.index('<div class="filter-controls-row">'))
        self.assertLess(html.index('<div class="filter-controls-row">'), html.index('id="filterSidebarClearBtn"'))
    ...
    def test_sidebar_metric_section_sits_above_grouped_kpis(self) -> None:
        _, html_body = self.assert_no_store("/")
        css = self.app_css_contract()
        html = html_body.decode("utf-8")
        js = self.app_js_contract()
        ...
        self.assertLess(html.index('class="section sidebar-metric-section hidden"'), html.index('class="section sidebar-kpi-section hidden"'))
        ...
        self.assertNotIn(".sidebar-kpi-section.kpi-collapsed .kpi-controls", css)
        self.assertIn(".sidebar-metric-section {\n        flex: 0 0 auto;", css)
        self.assertIn(".sidebar-metric-section .metric-row:last-child {\n        margin-bottom: 0;", css)
        ...
        self.assertIn(".sidebar-kpi-section {\n        display: flex;\n        flex-direction: column;\n        flex: 0 0 var(--sidebar-kpi-height, 160px);\n        margin-bottom: 0;\n        min-height: 0;\n        overflow: hidden;", css)
        ...
        self.assertIn(".sidebar-gbm-resizer::before {\n        background: color-mix(in srgb, var(--line) 70%, transparent);\n        border-radius: 999px;\n        content: \"\";\n        height: 2px;", css)
        self.assertIn(".sidebar-gbm-resizer:hover::before,\n      .sidebar-gbm-resizer.dragging::before {\n        background: var(--accent);", css)
        self.assertIn(".sidebar-filter-resizer {\n        cursor: row-resize;\n        height: 8px;\n        left: 0;\n        position: absolute;", css)
        self.assertIn(".sidebar-filter-resizer::before {\n        background: color-mix(in srgb, var(--line) 70%, transparent);\n        border-radius: 999px;\n        content: \"\";\n        height: 2px;", css)
        self.assertNotIn(".sidebar-gbm-resizer {\n        background: linear-gradient(to bottom, var(--line), transparent);", css)
        self.assertNotIn(".sidebar-glm-resizer {\n        background: linear-gradient(to bottom, var(--line), transparent);", css)
        self.assertNotIn(".sidebar-filter-resizer {\n        background: linear-gradient(to bottom, var(--line), transparent);", css)
        self.assertNotIn(".sidebar-gbm-resizer {\n        flex: 0 0 8px;", css)
        self.assertNotIn(".sidebar-glm-resizer {\n        flex: 0 0 8px;", css)
        ...
        self.assertIn(".sidebar-glm-resizer {\n        cursor: row-resize;\n        height: 8px;\n        left: 0;\n        position: absolute;", css)
        self.assertIn(".sidebar-glm-resizer::before {\n        background: color-mix(in srgb, var(--line) 70%, transparent);\n        border-radius: 999px;\n        content: \"\";\n        height: 2px;", css)
        ...
        self.assertIn('document.querySelector(".sidebar-metric-section")?.classList.toggle("hidden", tool === "column_profile");', js)
        self.assertIn('capacity -= visibleOuterHeight(document.querySelector(".sidebar-metric-section"));', js)
